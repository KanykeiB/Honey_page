...
const BlogPage = () => {
    return (
        <div className={styles.blog}>
            <h3>Блог</h3>
            <Link className={styles.link_blog} to='/blog/blog-page-one'>
            ...
            <Link className={styles.link_blog} to='/blog/blog-page-two'>
                <div className={styles.promo_block}>
                    <div className={styles.promo_pic}>
                        <img src={blog_2} alt="" />
                    </div>
            ...
            <Link className={styles.link_blog} to='/blog/blog-page-three'>
                <div className={styles.promo_block}>
                    <div className={styles.promo_pic}>
                        <img src={blog_3} alt="" />
                    </div>
