                    ...
                    <div className={s.text}>
                        ...
                        <div className={s.box}>
                            <div className={s.img1}>
                                <img src={img1} alt=""/>
                                <p>Начали держать пасеку с мая 1996 года, хозяйство было начато с 16 семьями (ящиков) пчёл
                                    среднерусской породы.
                                </p>

                                <p>
                                    В 2000 году перешли на карпатскую породу пчёл, количество семей (ящиков) около 15.
                                </p>
                                ...
                                <p>
                                    В 2022 году часть семей перевели на породу пчёл бакфаст 60 семей, а 50 семей оставили
                                    карнику.
                                </p>
                            </div>
                        </div>
